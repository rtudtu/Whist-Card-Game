...
/**
 * This class is provided to check that your code implements the expected API. If your code
 * compiles with an unmodified version of this class, then it very likely will also compile with
 * the tests that we use to evaluate your code.
 */
